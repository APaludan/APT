...
int main(void)
{
    ...
    long long int N = (filelen * bd/3.0); // number of samples
    printInfo(N, filelen);
...
{
    system("ffmpeg.exe -hide_banner -loglevel error -i underwater.png -q:v 2 -vf scale=50:-1 compressed.jpeg"); // compress
